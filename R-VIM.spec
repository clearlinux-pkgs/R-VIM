...
Version  : 4.7.0
Release  : 9
URL      : https://cran.r-project.org/src/contrib/VIM_4.7.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/VIM_4.7.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521268079
